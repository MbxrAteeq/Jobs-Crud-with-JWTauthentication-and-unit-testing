...
class testUserApi(unittest.TestCase):
	...
	def test_singUp_wrong(self):
		payload = {"fName":"Mubashar","lName":"Ateeq","email":"mubashar@gmail.com","userName":"ateeq","password":"abcdef"}
		r = requests.post(self.__api_base_url + self.__signUp, json=payload)
		self.assertEqual(r.status_code, 401)
		self.assertEqual(r.headers["Content-Type"], "application/json")

	def test_singUp_correct(self):
		payload = {"fName":"Mubashar","lName":"Ateeq","email":"mubashar@gmail.com","userName":"ateeqmubashar1","password":"flaskproject"}
		r = requests.post(self.__api_base_url + self.__signUp, json=payload)
		self.assertEqual(r.status_code, 200)
		self.assertEqual(r.headers["Content-Type"], "application/json")
