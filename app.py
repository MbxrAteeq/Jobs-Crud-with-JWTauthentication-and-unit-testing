...
# Getting values from system's env variables
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql:://' + os.environ.get('MYSQL_USER') + ':' + os.environ.get('MYSQL_PASSWORD') + '@' + os.environ.get('MYSQL_HOST') + ':5432/' + os.environ.get('MYSQL_DATABASE')
